...
public class Handler_ShoppinglistOverview {
    ...
    public List<GUI_Data_ShoppingList_Overview> GetOverviewData(Context context){
        ...
        return Prepare_ShoppingList_Overview_Data(shoppingList, context);
    }

    private List<GUI_Data_ShoppingList_Overview> Prepare_ShoppingList_Overview_Data(List<ShoppingList> shoppingList, Context context){
        ...
        for(int i = 0; i < shoppingList.size(); i++){
            ...
            ListPositionQueries lpq = new ListPositionQueries();
            shoppingList.get(i).Positions = lpq.GetByShoppingList(shoppingList.get(i),context);
